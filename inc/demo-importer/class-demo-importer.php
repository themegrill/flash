...
/**
 * Flash_Demo_Importer Class.
 */
class Flash_Demo_Importer {
	...
	public function __construct() {
		$this->plugin_data = array(
			...
			'name' => __( 'ThemeGrill Demo importer', 'flash' ),
		);
	...
	public function add_admin_menu() {
		add_theme_page( __( 'Demo Importer', 'flash' ), __( 'Demo Importer', 'flash' ), 'switch_themes', 'demo-importer', array( $this, 'demo_importer' ) );
	}
